...
// Abstract class for calculations (OOP + inheritance)
...
class Program
{
    // Dictionary to store employee logs
    ...
    static void Main(string[] args)
    {
        ...
        // Simulate Time-Out (for demo purposes, ask user to enter time out)
        ...
        // Calculate total hours using OOP
    ...
    // Method to get local time based on office location
